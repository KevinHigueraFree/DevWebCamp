<fieldset class="formulario__fieldset">
    ...
    <?php if (isset($ponente->imagen_actual)) { ?>
        <p class="formulario__texto">Imagen Actualizar</p>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="tags_input" placeholder="Java Script, Laravel, React js, Node js, etc.">
...
<fieldset class="formulario__fieldset">
    <legend class="formulario__legend">Sociales</legend>
    <div class="formulario__campo">
