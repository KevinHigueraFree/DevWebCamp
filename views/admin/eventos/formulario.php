<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="text" class="formulario__input" id="nombre" value="<?php echo $evento->nombre; ?>" name="nombre" placeholder="Nombre Evento">
    </div>
    <div class="formulario__campo">
    ...
    <div class="formulario__campo">
        <label for="dia" class="formulario__label">Elige el dia</label>
...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        ...
        <input type="number" min="1" class="formulario__input" id="disponibles" name="disponibles" placeholder="Ejemplo: 50" value="<?php echo $evento->disponibles; ?>">
