...
<section class="speakers">
    <h2 class="speakers__heading">Sepeakers</h2>
    ...
    <div class="speakers__grid">
        ...
        <?php foreach ($ponentes as $ponente) { ?>
            <div <?php  aos_animacion(); ?> class="speaker">
                <picture>
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.webp" type="image/webp" alt="Imagen del Ponente">
                    <source srcset="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" type="image/png" alt="Imagen del Ponente">
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo $_ENV['HOST'] . '/img/speakers/' . $ponente->imagen; ?>.png" alt="Imagen del Ponente">
                </picture>
                <div class="speaker__informacion">
                    ...
                    <ul class="speaker__listado-skills">
                        <!--  explode: saca las el primer parametro (comillas) de el segundo parametro(campo tags de ponente) -->
